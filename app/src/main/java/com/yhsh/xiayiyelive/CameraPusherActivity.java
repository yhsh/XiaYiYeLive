 ...
 * <p>
 * 2. 场景化配置参考：{@link } 与 {@link #setPushScene(int, boolean)} 您可以根据您的 App 使用设定不同的推流场景，SDK 内部会自动选择相关配置，让您可以快速搭建
 ...
 * <p>
 * 6. 混响、变声、码率自适应、硬件加速，使用参考： {@link } 与 {@link com.tencent.liteav}
 * <p>
 * 7. 横竖屏推流、静音、静画、观众端镜像、闪光灯、调试信息、水印、对焦、缩放功能，使用参考： {@link } 与 {@link com.tencent.liteav}
 * <p>
 * 8. 横屏推流使用参考：该功能较为复杂，需要区分Activity是否可以旋转。
 * A. 不可旋转情况下开启横屏推流：直接参考 {@link #(boolean)} 即可
...
//        initFragment();            // 初始化底部工具栏的两个Fragment
    ...
    private void initPusher() {
        ...
        mWaterMarkBitmap = decodeResource(getResources(), R.mipmap.watermark);
    }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        //可将下面的5个地址任意一个用VLC播放器打开即可就是观看直播功能
                        Log.e("打印推流地址1",rtmpPushUrl+"");
                        Log.e("打印推流地址2",rtmpPlayUrl+"");
                        Log.e("打印推流地址3",flvPlayUrl+"");
                        Log.e("打印推流地址4",hlsPlayUrl+"");
                        Log.e("打印推流地址5",realtimePlayUrl+"");
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
